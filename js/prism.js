...
var _self = "undefined" != typeof window ? window
    ...
    Prism = function(u) {
      var c = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, M = {
        ...
        util : {
          encode : function e(n) {
            return n instanceof W     ? new W(n.type, e(n.content), n.alias)
        ...
        highlightElement : function(e, n, t) {
          ...
          function o(e) {
            l.highlightedCode = e, M.hooks.run("before-insert", l),
            l.element.innerHTML = l.highlightedCode,
            M.hooks.run("after-highlight", l), M.hooks.run("complete", l),
            t && t.call(l.element)
          }
            ...
            for (var o in r)
              if (r.hasOwnProperty(o) && r[o]) {
                ...
                for (var u = 0; u < s.length; ++u) {
                  if (l && l.cause == o + "," + u)
                    return;
                  var c = s[u], g = c.inside, f = !!c.lookbehind,
                      h = !!c.greedy, d = 0, v = c.alias;
                  if (h && !c.pattern.global) {
                    var p = c.pattern.toString().match(/[imsuy]*$/)[0];
                    c.pattern = RegExp(c.pattern.source, p + "g")
                  }
                  for (var m = c.pattern || c, y = a.next, k = i;
                    ...
                    if (!(b instanceof W)) {
                      ...
                      if (w) {
                        ...
                        var A = w.index + d, O = w[0].slice(d),
                            P = A + O.length, L = b.slice(0, A), N = b.slice(P),
                            j = k + b.length;
      ...
      if (u.Prism = M, W.stringify = function n(e, t) {
            ...
            var a = {
              ...
              language : t
                ...
                i = e.alias;
            i && (Array.isArray(i) ? Array.prototype.push.apply(a.classes, i)
                                   : a.classes.push(i)),
                M.hooks.run("wrap", a);
            var l = "";
