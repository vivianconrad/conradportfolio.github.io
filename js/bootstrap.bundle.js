...
(function (global, factory) {
  ...
  function getContainingBlock(element) {
    ...
    while (
      ...
      var css = getComputedStyle$1(currentNode); // This is non-exhaustive but covers
  ...
  function arrow(_ref) {
    ...
    var clientSize = arrowOffsetParent
      ...
      : 0;
    var centerToReference = endDiff / 2 - startDiff / 2; // Make sure the arrow doesn't overflow the
...
*/
  ...
  function listScrollParents(element, list) {
    ...
    return isBody
      ? updatedList // $FlowFixMe[incompatible-call]: isBody tells
  ...
  function preventOverflow(_ref) {
    ...
    if (checkMainAxis) {
      ...
      var maxLen = variation === start ? -popperRect[len] : -referenceRect[len]; // We need to include the arrow in the
      ...
      var arrowPaddingMax = arrowPaddingObject[altSide]; // If the reference length is smaller than
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          state.reset = false;
          state.placement = state.options.placement; // On each update cycle, the `modifiersData`
